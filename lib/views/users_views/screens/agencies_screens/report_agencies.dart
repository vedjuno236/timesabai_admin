...
class ReportAgencies extends StatefulWidget {
  final String docId;

  ReportAgencies({required this.docId});

  @override
  State<ReportAgencies> createState() => _ReportAgenciesState();
}

class _ReportAgenciesState extends State<ReportAgencies> {
