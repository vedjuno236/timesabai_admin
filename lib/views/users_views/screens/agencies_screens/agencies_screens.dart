import 'package:admin_timesabai/views/users_views/screens/agencies_screens/report_agencies.dart';
...
class AgenciesScreens extends StatefulWidget {
  const AgenciesScreens({super.key});

  @override
  State<AgenciesScreens> createState() => _AgenciesScreensState();
}

class _AgenciesScreensState extends State<AgenciesScreens> {
              ...
              onTap: () async {
                try {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ReportAgencies(docId: docId),
                    ),
                  );
                } catch (e) {
