...
class ReportPosittion extends StatefulWidget {
  final String docId;
  ReportPosittion({required this.docId});

  @override
  State<ReportPosittion> createState() => _ReportPosittionState();
}

class _ReportPosittionState extends State<ReportPosittion> {
  late String _name;
