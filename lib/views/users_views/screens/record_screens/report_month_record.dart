...
class ReportMonthRecord extends StatefulWidget {
  ...
  const ReportMonthRecord({super.key, required this.searchName, required this.searchStatus,required this.monthDate});
        ...
        if (matchesName || matchesStatus) {
          ...
          if (date != null) {
            ...
            if (widget.monthDate != null) {
              if (recordDate.year != widget.monthDate!.year || recordDate.month != widget.monthDate!.month) {
              ...
              children: [
                ...
                pw.Center(
                  ...
                  pw.Container(
                      ...
                      pw.Container(
                        ...
                        child: pw.Text(
                          'ລາຍງານປະຈໍາເດືອນ:  ${widget.monthDate != null ? DateFormat('MMMM ','lo').format(widget.monthDate!) : ''}', // Add appropriate value if needed
                          style: pw.TextStyle(
                            font: font1,
                            fontSize: 15,
                          ),
                ...
                pw.Center(
                  child: pw.Table.fromTextArray(
                    ...
                    headers: ['ຊື່','ວັນທີ /ເດືອນ', 'ເຂົ້າວຽກ', 'ອອກວຽກ', 'ສະຖານະ'],
