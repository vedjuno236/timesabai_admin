...
class ReportDayLeave extends StatefulWidget {
  ...
  const ReportDayLeave({super.key, required this.searchQuery,required this.Day});
  ...
  Future<Uint8List> generateDocument(PdfPageFormat format) async {
    ...
    for (var employeeDoc in employeeSnapshot.docs) {
      ...
      for (var recordDoc in recordSnapshot.docs) {
        ...
        if (widget.searchQuery.isNotEmpty && employeeName != widget.searchQuery) {
          matchesName = false;
        }
        if (matchesName) {
              ...
              children: [
                ...
                pw.Center(
                  child: pw.Table.fromTextArray(
                    ...
                    headers: ['ຊື່','ວັນທີຂໍລາພັກ','ວັນທີລາພັກ','ວັນທີສີ້ນສູດ' ,'ສະຫຼຸບວັນພັກ', 'ປະເພດລາພັກ','ເຫດຜົນ', 'ສະຖານະ'],
