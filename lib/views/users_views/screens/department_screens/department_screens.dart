...
class _DepartmentScreensState extends State<DepartmentScreens> {
  ...
  Widget build(BuildContext context) {
    ...
    //               width: 6,   // Set width for better visibility
    ...
    //                 context,
    //                 MaterialPageRoute(
    //                   builder: (context) => ReportDepartment(docId: docId), // Ensure the constructor name is correct
    //                 ),
    //               );
    //             } catch (e) {
            ...
            onTap: () async {
              try {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ReportDepartment(docId: docId),
                  ),
                );
              } catch (e) {
                print('Error fetching document: $e');
