...
class TypeLeaveScreens extends StatefulWidget {
  const TypeLeaveScreens({super.key});

  @override
  State<TypeLeaveScreens> createState() => _TypeLeaveScreensState();
}

class _TypeLeaveScreensState extends State<TypeLeaveScreens> {
  ...
  final CollectionReference _items =
      FirebaseFirestore.instance.collection('type_leave');
