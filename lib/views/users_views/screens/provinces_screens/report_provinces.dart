...
class ReportProvinces extends StatefulWidget {
  final String docId;

  ReportProvinces({required this.docId});

  @override
  State<ReportProvinces> createState() => _ReportProvincesState();
}

class _ReportProvincesState extends State<ReportProvinces> {
