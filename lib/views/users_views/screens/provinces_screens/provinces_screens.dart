...
class ProvinceScreens extends StatefulWidget {
  const ProvinceScreens({super.key});

  @override
  State<ProvinceScreens> createState() => _ProvinceScreensState();
}

class _ProvinceScreensState extends State<ProvinceScreens> {
