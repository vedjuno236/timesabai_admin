          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text(
                    'ຂໍ້ມູນາສາຂາ', style: GoogleFonts.notoSansLao(
                ...
                Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) {
                        setState(() {
                          selectedDepartmentId = newValue; // Update selected department
                        });
                      },
                        ...
                        return DropdownMenuItem<String>(
                          ...
                          child: Text(
                            ...
                            style: GoogleFonts.notoSansLao(
                              textStyle: const TextStyle(
                                fontSize: 15,
                                color: Colors.black54, // Item text color
                              ),
                            ),
                          ),
                        );
...
// The TextField widget should be outside the DropdownButton
                TextField(
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        final String departmentId = selectedDepartmentId ?? '';
                        if (name.isNotEmpty) {
                          await _items.add({"name": name,"departmentId":departmentId});
  ...
  Future<void> fetchDepartments() async {
    departments = await ApiService().fetchDepartments(); // Correctly fetching departments
    setState(() {});
  }
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> streamSnapshot) {
          ...
          final List<DocumentSnapshot> items = streamSnapshot.data!.docs
              .where((doc) => doc['name'].toLowerCase().contains(searchText.toLowerCase()))
              .toList();
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              String departmentId = documentSnapshot['departmentId'];

              return FutureBuilder<DocumentSnapshot>(
                future: FirebaseFirestore.instance.collection('Department').doc(departmentId).get(),
                builder: (context, AsyncSnapshot<DocumentSnapshot> departmentSnapshot) {
                  ...
                  if (departmentSnapshot.hasData && departmentSnapshot.data != null) {
                    String departmentName = departmentSnapshot.data!['name'];
